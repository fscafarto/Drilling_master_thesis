...
class OPTIMAL{
    ...
    Eigen::Matrix<double,12,1> _q_dot_dot_des_temp;

    Eigen::Matrix<double,12,1> _f_gr_star_temp;

    Eigen::Matrix<double,30,30> weight_2;

    Eigen::Matrix<double,12,1> _qmin;

    Eigen::Matrix<double,12,1> _qmax;

    Eigen::Matrix<double,12,24> _B_opt;

    Eigen::Matrix<double,12,18> _JacCOM_lin;

    Eigen::Matrix<double,12,6> _Jstcom;

    Eigen::Matrix<double,6,1> _fext_st;
    ...
    Eigen::Matrix<double,6,6> _Jstcom_sw;

    Eigen::Matrix<double,6,1> _f_ext_sw;

    Eigen::Matrix<double,6,6> weight_3;
